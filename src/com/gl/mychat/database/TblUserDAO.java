 ...
 * TblUser entities. Transaction control of the save(), update() and delete()
 * operations can directly support Spring container-managed transactions or they
 * can be augmented to handle user-managed Spring transactions. Each of these
 * methods provides additional information for how to configure it for the
 * desired type of transaction control.
 * 
 * @see com.gl.mychat.database.TblUser
 * @author MyEclipse Persistence Tools
 */
public class TblUserDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory.getLogger(TblUserDAO.class);
	// property constants
	...
	public void save(TblUser transientInstance) {
		log.debug("saving TblUser instance");
		try {
	...
	public TblUser findById(java.lang.Long id) {
		...
		try {
			TblUser instance = (TblUser) getSession().get(
					"com.gl.mychat.database.TblUser", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(TblUser instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.gl.mychat.database.TblUser")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TblUser instance with property: " + propertyName
				+ ", value: " + value);
		try {
	...
	public List findAll() {
		log.debug("finding all TblUser instances");
		try {
			String queryString = "from TblUser";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public TblUser merge(TblUser detachedInstance) {
		...
		try {
			TblUser result = (TblUser) getSession().merge(detachedInstance);
